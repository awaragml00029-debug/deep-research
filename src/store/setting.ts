...
export const defaultValues: SettingStore = {
  ...
  modAIThinkingModel: process.env.NEXT_PUBLIC_MODAI_THINKING_MODEL || "gemini-2.5-flash",
  modAINetworkingModel: process.env.NEXT_PUBLIC_MODAI_NETWORKING_MODEL || "gemini-2.5-flash",
  googleVertexProject: "",
